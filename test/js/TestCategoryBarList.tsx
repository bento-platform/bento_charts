...
import { CategoryBarList, HexColor } from '../../src/index';
...
const TestCategoryBarList = () => {
  ...
  return <CategoryBarList data={DATA} colorsById={COLORS_BY_ID} selectedIds={selectedIds} onClick={onClick} />;
};

export default TestCategoryBarList;
